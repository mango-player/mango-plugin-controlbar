    ...
    methods: {
        ...
        _hideItself: function _hideItself() {
            ...
            this.timeId = setTimeout(function () {
                var bottom = _this.$wrap.offsetHeight;
                bottom = _this.children.progressBar ? _this.children.progressBar.$wrap[0].offsetTop - bottom : -bottom;
                (0, _mangoHelper.setStyle)(_this.$wrap, {
                    bottom: bottom + 'px'
                });
                (0, _mangoHelper.setStyle)(_this.$dom, {
                    visibility: 'hidden'
                });
...
var _progresstime = __webpack_require__(17);
...
var _clarity = __webpack_require__(19);
...
var Play = /** @class */function (_super) {
    ...
    Play.prototype.setPath = function (state) {
...
var Clarity = /** @class */function (_super) {
    ...
    Clarity.prototype.init = function () {
        ...
        // 用户自定义配置
        this.option.width && (0, _mangoHelper.setStyle)(this.$dom, 'width', this.option.width);
        this.initTextList();
    };
    Clarity.prototype.initTextList = function () {
        var _this = this;
